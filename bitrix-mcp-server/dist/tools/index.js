import { registerConsolidatedTools } from './consolidated/index.js';
/**
 ...
 */
export function registerTools(server, bitrixService) {
    registerConsolidatedTools(server, bitrixService);
}
