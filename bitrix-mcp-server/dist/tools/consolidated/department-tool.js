...
export function registerDepartmentTool(server, bitrixService) {
...
- fields: Get available department fields`,
        ...
        switch (action) {
            ...
            case 'employees': {
                ...
                const employees = await bitrixService.getDepartmentEmployees(params.departmentId, params.includeSubordinates);
                return {
                    content: [{
                            type: 'text',
                            text: JSON.stringify({
...
//# sourceMappingURL=department-tool.js.map