...
export function listTools(server: McpServer, bitrixService: BitrixService): void {
  // =============================================================================
  ...
  server.registerTool('bitrix_list_add', {
    ...
    if (params.bizproc !== undefined) fields.BIZPROC = params.bizproc ? 'Y' : 'N';

    const listId = await bitrixService.createList(
      params.iblockTypeId as IblockTypeId,
      params.iblockCode,
      fields as any,
  ...
  server.registerTool('bitrix_list_get', {
    ...
    const result = await bitrixService.getLists(
      params.iblockTypeId as IblockTypeId,
      params.iblockId,
      params.iblockCode,
      params.socnetGroupId,
  ...
  server.registerTool('bitrix_list_update', {
    ...
    const success = await bitrixService.updateList(
      params.iblockTypeId as IblockTypeId,
      params.iblockId,
      params.iblockCode,
  ...
  server.registerTool('bitrix_list_delete', {
    ...
    const success = await bitrixService.deleteList(
      params.iblockTypeId as IblockTypeId,
      params.iblockId,
      params.iblockCode
    );
  ...
  server.registerTool('bitrix_list_element_add', {
    ...
    const elementId = await bitrixService.createListElement(
      params.iblockTypeId as IblockTypeId,
      params.elementCode,
      fields,
      params.iblockId,
  ...
  server.registerTool('bitrix_list_element_get', {
    ...
    const result = await bitrixService.getListElements(
      params.iblockTypeId as IblockTypeId,
      params.iblockId,
      params.iblockCode,
      params.elementId,
  ...
  server.registerTool('bitrix_list_element_update', {
    ...
    const success = await bitrixService.updateListElement(
      params.iblockTypeId as IblockTypeId,
      params.elementId,
      params.elementCode,
      fields,
  ...
  server.registerTool('bitrix_list_element_delete', {
    ...
    const success = await bitrixService.deleteListElement(
      params.iblockTypeId as IblockTypeId,
      params.elementId,
      params.elementCode,
      params.iblockId,
  ...
  server.registerTool('bitrix_list_element_file_url', {
    ...
    const url = await bitrixService.getListElementFileUrl(
      params.iblockTypeId as IblockTypeId,
      params.elementId,
      fieldId,
      params.iblockId,
  ...
  server.registerTool('bitrix_list_field_add', {
    ...
    if (params.code) fields.CODE = params.code;
    if (params.isRequired !== undefined) fields.IS_REQUIRED = params.isRequired ? 'Y' : 'N';
    if (params.multiple !== undefined) fields.MULTIPLE = params.multiple ? 'Y' : 'N';
    if (params.sort !== undefined) fields.SORT = params.sort;
    if (params.defaultValue !== undefined) fields.DEFAULT_VALUE = params.defaultValue;
    ...
    const fieldId = await bitrixService.createListField(
      params.iblockTypeId as IblockTypeId,
      fields as any,
      params.iblockId,
      params.iblockCode,
  ...
  server.registerTool('bitrix_list_field_get', {
    ...
    const fields = await bitrixService.getListFields(
      params.iblockTypeId as IblockTypeId,
      params.iblockId,
      params.iblockCode,
      params.fieldId,
  ...
  server.registerTool('bitrix_list_field_update', {
    ...
    if (params.sort !== undefined) fields.SORT = params.sort;
    if (params.defaultValue !== undefined) fields.DEFAULT_VALUE = params.defaultValue;
    if (params.listValues) fields.LIST_TEXT_VALUES = params.listValues.join('\n');

    const success = await bitrixService.updateListField(
      params.iblockTypeId as IblockTypeId,
      params.fieldId,
      fields as any,
      params.iblockId,
  ...
  server.registerTool('bitrix_list_field_delete', {
    ...
    const success = await bitrixService.deleteListField(
      params.iblockTypeId as IblockTypeId,
      params.fieldId,
      params.iblockId,
      params.iblockCode,
  ...
  server.registerTool('bitrix_list_field_types', {
    ...
    const types = await bitrixService.getListFieldTypes(
      params.iblockTypeId as IblockTypeId,
      params.iblockId,
      params.iblockCode,
      params.socnetGroupId
