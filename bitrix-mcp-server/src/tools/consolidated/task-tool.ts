...
import { BitrixTask } from '../../types/bitrix.js';
...
export function registerTaskTool(server: McpServer, bitrixService: BitrixService): void {
        ...
        return {
          content: [{
            ...
            text: JSON.stringify({
              ...
              tasks: limitedTasks.map((t: BitrixTask) => ({
                id: t.id,
                title: t.title,
                status: t.status,
